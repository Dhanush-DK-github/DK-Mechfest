...
<head>
    ...
    <title>DK MechFest - Scrap Master</title>
                        ...
                        <div class="col">
                            <div class="each_event_Content">
                                        <div class="row mt-3 text-center">
                                            <div class="col-12">
                                                <h1>SCRAP MASTER <span>- Waste But Not Lost</span></h1>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <p>Built any kind of model or structure by using only scrap (waste material).</p>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                ...
                                                <p><ul>
                                                    ...
                                                    <li>Scrap Master will have two rounds - Prelims and Finals.</li>
                                        ...
                                        <div class="row mt-3 mb-5 text-center">
                                            <a href="././Scrap_Master/register"><button class="btn" id="eachEventRegisterButton">Register</button></a>
                                        </div>
                            </div>
                            <div class="PPT_Image">
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <img src="../../CSS/images/EventsImages/Scrap_master_image.jpg" alt="Casting Image" width="100%">
                                        </div>
                                    </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    <div class="card suggestion_form" id="suggestion-form">
                        ...
                        <div class="card-body">
                            <form:form action="././Scrap_Master/sendSuggestion" method="post" autocomplete="off" id="suggestion_form_label_input" onsubmit="return validateSuggestionForm(this)" novalidate="true" modelAttribute="suggestion">
                                <div class="mb-3">
