                ...
                <div class="header-title" id="events-header-title">
                    <div class="row p-2 align-items-center justify-content-center">
                        <div class="col-10 text-center">
                            <h1><span>PAPER PRESENTATION</span></h1>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col">
                            <div class="each_event_Content">
                                        <div class="row mt-3 text-center">
                                            <div class="col-12">
                                                <h1>PAPER PRESENTATION <span>- MechTedx</span></h1>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <p>All you need to do is to fuel your brain to stimulate the ideas that never existed.The planet is all yours and come up with a spark of innovation to improve the lives around you.The stage has bee set to listen to your words. Hope you fulfill the expectation in the form of <span><i>Paper Presentation</i>.</span> Abstracts should be sent on or before <span><i>9th OCT 2023</i>.</span><br>
                                                <i>Now the countdown starts, Rememer that your clock is ticking!</i></p>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                ...
                                                <p><ul>
                                                    <li>Maximum of 2 members in a team.</li>
                                                    <li>Paper can be based on any technical key area related to Mechanical field.</li>
                                                    <li>The Abstract should be within <span><b><i>250-300 words </i></b></span>with the title of the paper being crisp and clear.</li>
                                                    <li>The paper should not exceed <span><b><i>15 pages</i></b></span>.</li>
                                                    <li>Softcopy should be in the file format <span><b><i>".docx or.pdf"</i></b></span>.</li>
                                                    <li>Team will be provided 7 mins to present your excellence followed b Q&A session for the last 3 mins respectively.</li>
                                                    <li>The abstract should be attached to the mail id <span><b>- mechfest.2024@gmail.com</b></span> on or before 9th OCT 2023, beyond which submission of the papers will not be validated.</li>
                                                    <li>Remember that your first impression is the best one, we expect the participants to maintain a <span><b><i>Formal Dress Code</i></b></span>.</li>
                                                    <li>Softcopies with two hardcopy should be submitted to our event co-ordinators avilable at the workdesk, before the event.</li>
                                                </ul></p> 
                                            </div>
                                        </div>
                                        <div class="row mt-3 mb-5 text-center">
                                            <a href="././Paper_Presentation/register"><button class="btn" id="eachEventRegisterButton">Register</button></a>
                                        </div>
                            </div>
                            <div class="PPT_Image">
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <img src="../../CSS/images/EventsImages/PPT_image_1.jpg" alt="PPT Image" width="100%">
                                        </div>
                                    </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    <div class="card suggestion_form" id="suggestion-form">
                        ...
                        <div class="card-body">
                            <form:form action="././Paper_Presentation/sendSuggestion" method="post" autocomplete="off" id="suggestion_form_label_input" onsubmit="return validateSuggestionForm(this)" novalidate="true" modelAttribute="suggestion">
                                <div class="mb-3">
