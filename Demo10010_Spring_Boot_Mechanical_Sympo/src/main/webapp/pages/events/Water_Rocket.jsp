...
<head>
    ...
    <title>DK MechFest - Aqua Fly</title>
                        ...
                        <div class="col">
                            <div class="each_event_Content">
                                        <div class="row mt-3 text-center">
                                            <div class="col-12">
                                                <h1>WATER ROCKET <span>- Aqua Fly</span></h1>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <p>Students should build a water rocket designed to fly the greatest distance.</p>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                ...
                                                <p><ul>
                                                    <li>It is a Group Event.</li>
                                                    <li>A team of 2-3 members can participate.</li>
                                                    <li>Only pne rocket is allowed for a team <span><b>(No Backup Rockets)</b></span>.</li>
                                                    <li>Rocket Constraints should be as below,</li>
                                                        <ul class="subList"><li>Rocket should be made with only plastic bottles.</li>
                                                        <li>Participant can fill water to the desired level (with safety consideration).</li>
                                                        <li><span><b>40 to 60 psi</b></span> pressure is allowed.</li>
                                                        <li>Participants should use <span><b>2.25L PET bottles</b></span>.</li></ul>
                                                    <li>Students are encouraged to be creative in the design of the nose cones (To avoid accidental injuries, cone shuld be somewhat round, not sharp), including fins to their water rockets. <span><i>Stricly no form of metal is allowed</i></span>.</li>
                                                    <li><span><i>Viva (about the RC car) </i></span>will be conducted at the commencement of event.</li>
                                                    <li>Winning Criteria is based on Design of the Car, How long distance the rocket have flown and Viva marks.</li>
                                                </ul></p> 
                                            </div>
                                        </div>
                                        <div class="row mt-3 mb-5 text-center">
                                            <a href="././Water_Rocket/register"><button class="btn" id="eachEventRegisterButton">Register</button></a>
                                        </div>
                            </div>
                            <div class="PPT_Image">
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <img src="../../CSS/images/EventsImages/Water_Rocket_image_1.png" alt="PPT Image" width="100%">
                                        </div>
                                    </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    <div class="card suggestion_form" id="suggestion-form">
                        ...
                        <div class="card-body">
                            <form:form action="././Water_Rocket/sendSuggestion" method="post" autocomplete="off" id="suggestion_form_label_input" onsubmit="return validateSuggestionForm(this)" novalidate="true" modelAttribute="suggestion">
                                <div class="mb-3">
