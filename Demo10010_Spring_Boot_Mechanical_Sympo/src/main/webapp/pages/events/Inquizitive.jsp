                        ...
                        <div class="col">
                            <div class="each_event_Content">
                                        <div class="row mt-3 text-center">
                                            <div class="col-12">
                                                <h1>IN<span>QUIZ</span>ITIVE <span>- Quiz / Mind Sport</span></h1>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <p>It is a mind sport in which players attempt to answer questions correctly on one or several specific topics.</p>
                                                <p>Quiz questions will be come from Mechanical Engineering Topics.</p>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                ...
                                                <p><ul>
                                                    ...
                                                    <li>Quiz will have two rounds - Prelims and Finals.</li>
                                                        <ul class="subList"><li>Prelims will be a written round.</li>
                                                        <li>Top Teams from prelims will make it to the finals.</li></ul>
                                                    <li>Both Prelims and Finals marks will be considered for Final Evaluation.</li>
                                                </ul></p> 
                                            </div>
                                        </div>
                                        <div class="row mt-3 mb-5 text-center">
                                            <a href="././Inquizitive/register"><button class="btn" id="eachEventRegisterButton">Register</button></a>
                                        </div>
                            </div>
                            <div class="PPT_Image">
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <img src="../../CSS/images/EventsImages/quiz_image_2.jpg" alt="PPT Image" width="100%">
                                        </div>
                                    </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    <div class="card suggestion_form" id="suggestion-form">
                        ...
                        <div class="card-body">
                            <form:form action="././Inquizitive/sendSuggestion" method="post" autocomplete="off" id="suggestion_form_label_input" onsubmit="return validateSuggestionForm(this)" novalidate="true" modelAttribute="suggestion">
                                <div class="mb-3">
