...
<head>
    ...
    <title>DK MechFest - Assemble & Dismantle</title>
                ...
                <div class="header-title" id="events-header-title">
                    <div class="row p-2 align-items-center justify-content-center">
                        <div class="col-10 text-center">
                            <h1><span>ASSEMBLE & DISMANTLE</span></h1>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col">
                            <div class="each_event_Content">
                                        <div class="row mt-3 text-center">
                                            <div class="col-12">
                                                <h1>ASSEMBLE & DISMANTLE <span>- Yet To Be Engineered</span></h1>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <p>Skill required to confirm competency in the dismantling and assembling of Mechanical Equipments.</p>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                ...
                                                <p><ul>
                                                    ...
                                                    <li>A team of 2 members can participate.</li>
                                                    <li>Assemble & Dismantle will have two rounds - Prelims and Finals.</li>
                                                        <ul class="subList"><li>Prelims will be a written round.</li>
                                                        <li>Top Teams from prelims will make it to the finals.</li></ul>
                                                    <li>Prelims marks will not be considered for final evaluation.</li>
                                                    <li>Top Students from finals will be considered as Winners.</li>
                                                </ul></p> 
                                            </div>
                                        </div>
                                        <div class="row mt-3 mb-5 text-center">
                                            <a href="././Assemble_Dismantle/register"><button class="btn" id="eachEventRegisterButton">Register</button></a>
                                        </div>
                            </div>
                            <div class="PPT_Image">
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <img src="../../CSS/images/EventsImages/Assemble_dismantle_image.png" alt="Casting Image" width="100%">
                                        </div>
                                    </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    <div class="card suggestion_form" id="suggestion-form">
                        ...
                        <div class="card-body">
                            <form:form action="././Assemble_Dismantle/sendSuggestion" method="post" autocomplete="off" id="suggestion_form_label_input" onsubmit="return validateSuggestionForm(this)" novalidate="true" modelAttribute="suggestion">
                                <div class="mb-3">
