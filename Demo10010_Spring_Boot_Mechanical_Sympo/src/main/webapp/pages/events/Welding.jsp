...
<head>
    ...
    <title>DK MechFest - Welding</title>
                        ...
                        <div class="col">
                            <div class="each_event_Content">
                                        <div class="row mt-3 text-center">
                                            <div class="col-12">
                                                <h1>WELDING <span>- Mr. Spark</span></h1>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <p>It is a fabrication process whereby two or more parts are fused together by means of heat, pressure or both forming a join as the parts cool.</p>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                ...
                                                <p><ul>
                                                    ...
                                                    <li>Welding will have two rounds - Prelims and Finals.</li>
                                                        <ul class="subList"><li>Prelims will be a written round.</li>
                                                        <li>Top Students from prelims will make it to the finals.</li><li>Finals will be a practical one where you have to weld the required joints.</li></ul>
                                        ...
                                        <div class="row mt-3 mb-5 text-center">
                                            <a href="././Welding/register"><button class="btn" id="eachEventRegisterButton">Register</button></a>
                                        </div>
                            </div>
                            <div class="PPT_Image">
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <img src="../../CSS/images/EventsImages/Welding_image_3.jpg" alt="PPT Image" width="100%">
                                        </div>
                                    </div>
                            </div>
                        </div>
