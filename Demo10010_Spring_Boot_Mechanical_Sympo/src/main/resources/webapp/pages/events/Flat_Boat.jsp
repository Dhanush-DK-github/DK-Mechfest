...
<head>
    ...
    <title>DK MechFest - Flat Boat</title>
                        ...
                        <div class="col">
                            <div class="each_event_Content">
                                        <div class="row mt-3 text-center">
                                            <div class="col-12">
                                                <h1>FLAT BOAT <span>- Boat Race</span></h1>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <p>Prepare a miniature model boat that can be controlled from a distance using a specialized transmitter or remote.</p>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                ...
                                                <p><ul>
                                                    ...
                                                    <li>A team of 3 members can participate.</li>
                                                    <li>Boat Dimensions and Constraints should be as below,</li>
                                                        <ul class="subList"><li><span><b>Total Width: </b></span>should be 8 cm.</li>
                                                        <li><span><b>Total Length: </b></span>should be 25 cm.</li>
                                                        <li>Torque motor should not be used.</li></ul>
                                                    <li><span><i>Viva (about the Flat Boat) </i></span>will be conducted at the commencement of event.</li>
                                                    <li>Winning Criteria is based on Design of the Boat, How long the boat have ran and Viva marks.</li>
                                                </ul></p> 
                                            </div>
                                        </div>
                                        <div class="row mt-3 mb-5 text-center">
                                            <a href="././Flat_Boat/register"><button class="btn" id="eachEventRegisterButton">Register</button></a>
                                        </div>
                            </div>
                            <div class="PPT_Image">
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <img src="../../CSS/images/EventsImages/Flat_Boat_1.jpg" alt="Flat boat Image" width="100%">
                                        </div>
                                    </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    <div class="card suggestion_form" id="suggestion-form">
                        ...
                        <div class="card-body">
                            <form:form action="././Flat_Boat/sendSuggestion" method="post" autocomplete="off" id="suggestion_form_label_input" onsubmit="return validateSuggestionForm(this)" novalidate="true" modelAttribute="suggestion">
                                <div class="mb-3">
