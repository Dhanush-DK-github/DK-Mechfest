...
<head>
    ...
    <title>DK MechFest - RC Car</title>
                        ...
                        <div class="col">
                            <div class="each_event_Content">
                                        <div class="row mt-3 text-center">
                                            <div class="col-12">
                                                <h1>RC CAR <span>- Car Race</span></h1>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                <p>Prepare a miniature model car that can be controlled from a distance using a specialized transmitter or remote.</p>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                ...
                                                <p><ul>
                                                    ...
                                                    <li>Car Dimensions and Constraints should be as below,</li>
                                                        <ul class="subList"><li><span><b>Track Width: </b></span>less than 12 cm.</li>
                                                        <li><span><b>Wheel Base: </b></span>less than 20 cm.</li>
                                                        <li>Torque motor should not be used.</li>
                                                        <li>CD should not be used for wheels.</li></ul>
                                                    <li><span><i>Viva (about the RC car) </i></span>will be conducted at the commencement of event.</li>
                                                    <li>Winning Criteria is based on Design of the Car, How long the car have ran and Viva marks.</li>
                                                </ul></p> 
                                            </div>
                                        </div>
                                        <div class="row mt-3 mb-5 text-center">
                                            <a href="././RC_Car/register"><button class="btn" id="eachEventRegisterButton">Register</button></a>
                                        </div>
                            </div>
                            <div class="PPT_Image">
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <img src="../../CSS/images/EventsImages/RC_image_4.jpg" alt="PPT Image" width="100%">
                                        </div>
                                    </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    <div class="card suggestion_form" id="suggestion-form">
                        ...
                        <div class="card-body">
                            <form:form action="././RC_Car/sendSuggestion" method="post" autocomplete="off" id="suggestion_form_label_input" onsubmit="return validateSuggestionForm(this)" novalidate="true" modelAttribute="suggestion">
                                <div class="mb-3">
